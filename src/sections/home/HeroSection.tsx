  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-20 right-10 w-72 h-72 bg-primary/10 rounded-full filter blur-3xl" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div>
                <a href="#projects">
                  <Button className="px-8 py-6 text-base">View My Work</Button>
                </a>
              </div>
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <a
                    key={social.name}
                    href="#"
                    className="w-10 h-10 bg-foreground/5 rounded-full flex items-center justify-center hover:bg-primary hover:text-brand transition-colors"
