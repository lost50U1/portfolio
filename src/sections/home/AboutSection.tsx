        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slideUp">
            ...
            <p className="mb-6 text-lg">
              ...
              experience in creating modern, responsive, and user-friendly web
              applications.
            </p>
            <p className="mb-6">
              ...
              solutions. I'm particularly interested in creating applications
              that not only look good but also deliver exceptional user
              experiences.
            </p>
            <p className="mb-8">
